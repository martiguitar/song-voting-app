/*
  # Update song blocking functionality
  
  1. Changes
    - Remove password requirement for blocking/unblocking
    - Maintain 28-day block duration
    - Keep vote clearing on block
    - Keep real-time updates enabled
    
  2. Security
    - Allow public access to blocking functionality
